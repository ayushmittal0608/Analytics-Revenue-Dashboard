...
let AnalyticsController = class AnalyticsController {
    ...
    async getRevenueByCategory(request, region) {
        const user = request.user;
        return this.analyticsService.getRevenueByCategory(user, region);
    }
    async getRevenueOverTime(request, period = '3M', region = 'ALL') {
        const user = request.user;
        return this.analyticsService.getRevenueOverTime(user, period, region);
    }
};
...
], AnalyticsController.prototype, "getRevenueByCategory", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
